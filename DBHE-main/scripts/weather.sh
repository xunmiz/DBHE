...
do
    ...
    python -u /data/coding/DBHE-main/run_longExp.py \
      ...
      --train_epochs 100\
      --gpu 0\
      --itr 1 --batch_size 128 --learning_rate $learning_rate >logs/LongForecasting/weather/$model_name'_'$pred_len'_'$T_num_expert'_'$T_top_k'_'$F_num_expert'_'$F_top_k'_'$learning_rate'_'$rank'_'$d_embed'_'$ortho_loss_weight'_'$k.log
done
done
done
done
